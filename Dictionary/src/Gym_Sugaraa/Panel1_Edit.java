...
public class Panel1_Edit extends JPanel{

    Panel1_Edit(int dugaar) {
        
        setLayout(new BorderLayout());
        setBorder(BorderFactory.createTitledBorder("Засах нэмэх"));
        ...
        JButton btnEdit = new JButton("Засах");
        ...
        btnEdit.setPreferredSize(new Dimension(130,20));
        ...
        String query1 = "select * from gym_register where reg_id = "+dugaar+"";
        ResultSet rs = Gym_Database.runQuery(query1);
        try 
        {
            while(rs.next())
            {
                fld1.setText(rs.getString("reg_lastname"));
                fld2.setText(rs.getString("reg_fistname"));
                fld4.setText(rs.getString("reg_payment"));
                fld5.setText(rs.getString("reg_phone"));
                fld6.setText(rs.getString("reg_start"));
                fld7.setText(rs.getString("reg_end"));
                String gay=rs.getString("reg_sex");
                if(gay.equals("Эр"))
                {
